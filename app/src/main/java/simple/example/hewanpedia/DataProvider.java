...
public class DataProvider {
    ...
    private static List<Burung> initDataBurung(Context ctx) {
        ...
        burungs.add(new Burung("Burung kenari", "Indonesia",
                "burung kenari dengan nama latin serinus canaria burung ini bukan asli dari indonesia pertamakali ditemukan oleh seorang pelaut prancis.", R.drawable.kenari));
        burungs.add(new Burung("burung gelatik ", "indonesia ",
                "adalah burung khas indonesia lebih tepatnya berasal dari pulau jawa", R.drawable.gelatik));
        burungs.add(new Burung("burung pipit", "Indonesia",
                " burung pipit sebutan khusus bagi masyrakat jawa burung pipit ini hidup dalam kelompok kelompok.", R.drawable.pipit));
        burungs.add(new Burung("Burung pleci", "indonesia",
                "Burung ini cukup laku di pasaran ada juga komunitasnya yg bernama pleci mania.", R.drawable.pleci));
        burungs.add(new Burung("Burung ciblek", "Indonesia",
                "dalam bahasa latin di sebut prinia familiaris burungnya kecil grakkanya sangat lincah.", R.drawable.ciblek));
        burungs.add(new Burung("Burung kolibri", "Indonesia",
                "Burung kolibri di juluki burung madu karena makanannya madu yg terdapat sari2 bungaa.  ", R.drawable.kolibri));
        return burungs;
    }
